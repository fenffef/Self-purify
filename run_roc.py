...
if __name__ == '__main__':
    ...
    if args.mode != "train":
        ...
        train_cmd = f" python train.py  --gpus {args.gpus} --mode train --max_src_len 100 --max_tgt_len 100 " \
        ...
        train_cmd += f" --warmup False --batch_size {args.batch_size} --lr 5e-5 --n_epochs 10 " \
